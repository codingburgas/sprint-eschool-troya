...
void computerNetworkHomework() {
    ...
    while (selectedQuestions.size() < 5) {
        int randomIndex = rand() % networkingQuestions.size();
        selectedQuestions.push_back(networkingQuestions[randomIndex]);
    }
...
void operatingSystemsHomework() {
    ...
    srand(time(0));
    while (selectedQuestions.size() < 5) {
        int randomIndex = rand() % operatingSystemsQuestions.size();
        selectedQuestions.push_back(operatingSystemsQuestions[randomIndex]);
    }
...
void cloudComputingHomework() {
    ...
    srand(time(0));
    while (selectedQuestions.size() < 5) {
        int randomIndex = rand() % cloudComputingQuestions.size();
        selectedQuestions.push_back(cloudComputingQuestions[randomIndex]);
    }
